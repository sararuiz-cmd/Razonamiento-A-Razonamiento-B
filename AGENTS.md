...
- Crea la clase de la acción en el paquete `proyecto.com.Razonamiento_A_B.acciones`, normalmente extendiendo `ViewBaseAction`
...
<controlador nombre="TuPrimeraEntidad">
    ...
    <accion nombre="mostrarImporte" modo="detail"
        clase="proyecto.com.Razonamiento_A_B.acciones.MostrarImporte"/>
</controlador>
```

```java
package proyecto.com.Razonamiento_A_B.acciones;
...
- ✅ Coloca las clases de acción en `proyecto.com.Razonamiento_A_B.acciones`
...
```java
package proyecto.com.Razonamiento_A_B.pruebas;
...
- Crea un paquete `cuadrosmando` (ej. `proyecto.com.Razonamiento_A_B.cuadrosmando`) y coloca la clase `CuadroMando` y sus clases auxiliares en él.
