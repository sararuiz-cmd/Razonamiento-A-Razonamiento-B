...
En Razonamiento_A_B-labels_es.properties:
Razonamiento_A_B=Tu aplicación
Razonamiento_A_B[description]=Tu aplicación hace esto y lo otro

En Razonamiento_A_B-messages_en.properties:
